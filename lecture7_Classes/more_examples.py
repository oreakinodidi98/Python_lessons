...
my_jazz_collection = MyCollection(["Miles Davis", "John Coltrane", "Thelonious Monk"])
# attempt to use Len function
print(len(my_jazz_collection)) # output: 3
...
######################## Example 3: Preparing and accessing Controlled Attributes and Methods ########################
